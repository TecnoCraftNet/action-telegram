    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (status) {
            ...
            case 'failure':
                ...
                break;
            default:
                displayStatus = 'attenzione';
                break;
        }
        const uri = `https://api.telegram.org/bot${botToken}/sendMessage`;
        const text = `${icon} [${repoFullname}](${repoUrl}/actions) ${workflow} *${displayStatus}*

  \`${ref}\` \`${sha.substr(0, 7)}\` da *${actor}*

  [Vedi dettagli](${repoUrl}/commit/${sha}/checks)`;
